...
var $author$project$Types$AttackerMove = {$: 'AttackerMove'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Types$defaultIVs = {atk: 31, def: 31, hp: 31, spa: 31, spd: 31, spe: 31};
var $author$project$Types$defaultMove = {hits: 1, isCrit: false, name: ''};
var $author$project$Types$defaultStats = {atk: 0, def: 0, hp: 0, spa: 0, spd: 0, spe: 0};
var $author$project$Types$defaultAttacker = {
	ability: 'Static',
	boosts: $author$project$Types$defaultStats,
	curHP: 100,
	evs: {atk: 0, def: 0, hp: 0, spa: 252, spd: 4, spe: 252},
	isDynamaxed: false,
	item: '',
	ivs: $author$project$Types$defaultIVs,
	level: 50,
	moves: _List_fromArray(
		[
			{hits: 1, isCrit: false, name: 'Thunderbolt'},
			{hits: 1, isCrit: false, name: 'Volt Switch'},
			$author$project$Types$defaultMove,
			$author$project$Types$defaultMove
		]),
	nature: 'Timid',
	species: 'Pikachu',
...
var $author$project$Types$defaultDefender = {
	ability: 'Blaze',
	boosts: $author$project$Types$defaultStats,
	curHP: 100,
	evs: {atk: 0, def: 0, hp: 0, spa: 252, spd: 4, spe: 252},
...
var $author$project$Types$defaultSideConditions = {isAuroraVeil: false, isHelpingHand: false, isLightScreen: false, isReflect: false, isSteathRock: false, isTailwind: false, spikes: 0};
var $author$project$Types$defaultField = {attackerSide: $author$project$Types$defaultSideConditions, defenderSide: $author$project$Types$defaultSideConditions, gameType: 'Singles', isGravity: false, terrain: '', weather: ''};
...
var $author$project$Main$init = function (flags) {
	...
	var initialModel = {abilityList: _List_Nil, allGameData: $elm$core$Dict$empty, attacker: $author$project$Types$defaultAttacker, attackerBaseStatsCollapsed: false, attackerLearnset: $elm$core$Maybe$Nothing, attackerSource: $elm$core$Maybe$Nothing, availableGames: _List_Nil, battleStateCollapsed: true, box: _List_Nil, boxCollapsed: true, boxMatchupResults: $elm$core$Dict$empty, defender: $author$project$Types$defaultDefender, defenderBaseStatsCollapsed: false, defenderEditMode: false, defenderLearnset: $elm$core$Maybe$Nothing, dragState: $elm$core$Maybe$Nothing, field: $author$project$Types$defaultField, fieldCollapsed: true, fieldConditionsDropdownOpen: false, filteredEncounters: _List_Nil, generation: initialGen, itemList: _List_Nil, levelCap: $elm$core$Maybe$Nothing, loading: true, moveList: _List_Nil, natureList: _List_Nil, openDropdown: $elm$core$Maybe$Nothing, pokemonList: _List_Nil, result: $elm$core$Maybe$Nothing, selectedGame: initialGame, selectedMoveIndex: 0, selectedMoveSource: $author$project$Types$AttackerMove, selectedTrainerIndex: 0, settingsLoaded: false, showResetConfirmDialog: false, team: _List_Nil, trainerEncounters: _List_Nil, trainerSearchQuery: ''};
...
var $author$project$Main$ReceivedBoxMatchupResult = function (a) {
	return {$: 'ReceivedBoxMatchupResult', a: a};
};
...
var $author$project$Main$ReceivedLearnset = function (a) {
	return {$: 'ReceivedLearnset', a: a};
};
...
var $author$project$Main$receiveBoxMatchup = _Platform_incomingPort('receiveBoxMatchup', $elm$json$Json$Decode$value);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Main$receiveLearnset($author$project$Main$ReceivedLearnset),
				...
				$author$project$Main$receiveBoxMatchup($author$project$Main$ReceivedBoxMatchupResult)
			]));
};
var $author$project$Types$AttackerAbilityDropdown = {$: 'AttackerAbilityDropdown'};
var $author$project$Types$AttackerItemDropdown = {$: 'AttackerItemDropdown'};
var $author$project$Types$AttackerMoveDropdown = function (a) {
	return {$: 'AttackerMoveDropdown', a: a};
};
var $author$project$Types$DefenderAbilityDropdown = {$: 'DefenderAbilityDropdown'};
var $author$project$Types$DefenderItemDropdown = {$: 'DefenderItemDropdown'};
var $author$project$Types$DefenderMove = {$: 'DefenderMove'};
var $author$project$Types$DefenderMoveDropdown = function (a) {
	return {$: 'DefenderMoveDropdown', a: a};
};
var $author$project$Types$FromBox = function (a) {
	return {$: 'FromBox', a: a};
};
var $author$project$Types$FromTeam = function (a) {
	return {$: 'FromTeam', a: a};
};
...
var $author$project$Decoders$abilityListDecoder = A2(
...
var $author$project$Decoders$availableGamesDecoder = A2(
	$elm$json$Json$Decode$field,
	'games',
	$elm$json$Json$Decode$list($elm$json$Json$Decode$string));
var $author$project$Types$BoxMatchupResult = function (boxIndex) {
	return function (attackerSpeed) {
		return function (defenderSpeed) {
			return function (canOHKO) {
				return function (mightOHKO) {
					return function (getsOHKOd) {
						return function (mightGetOHKOd) {
							return function (isHardCounter) {
								return function (isWall) {
									return function (bestDamagePercent) {
										return function (worstDamageTaken) {
											return {attackerSpeed: attackerSpeed, bestDamagePercent: bestDamagePercent, boxIndex: boxIndex, canOHKO: canOHKO, defenderSpeed: defenderSpeed, getsOHKOd: getsOHKOd, isHardCounter: isHardCounter, isWall: isWall, mightGetOHKOd: mightGetOHKOd, mightOHKO: mightOHKO, worstDamageTaken: worstDamageTaken};
										};
									};
								};
							};
...
var $author$project$Decoders$andMap = $elm$json$Json$Decode$map2($elm$core$Basics$apR);
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $author$project$Decoders$boxMatchupResultDecoder = A2(
	$author$project$Decoders$andMap,
	A2($elm$json$Json$Decode$field, 'worstDamageTaken', $elm$json$Json$Decode$float),
	A2(
		$author$project$Decoders$andMap,
		A2($elm$json$Json$Decode$field, 'bestDamagePercent', $elm$json$Json$Decode$float),
		A2(
			$author$project$Decoders$andMap,
			A2($elm$json$Json$Decode$field, 'isWall', $elm$json$Json$Decode$bool),
			A2(
				$author$project$Decoders$andMap,
				A2($elm$json$Json$Decode$field, 'isHardCounter', $elm$json$Json$Decode$bool),
				A2(
					$author$project$Decoders$andMap,
					A2($elm$json$Json$Decode$field, 'mightGetOHKOd', $elm$json$Json$Decode$bool),
					A2(
						$author$project$Decoders$andMap,
						A2($elm$json$Json$Decode$field, 'getsOHKOd', $elm$json$Json$Decode$bool),
						A2(
							$author$project$Decoders$andMap,
							A2($elm$json$Json$Decode$field, 'mightOHKO', $elm$json$Json$Decode$bool),
							A2(
								$author$project$Decoders$andMap,
								A2($elm$json$Json$Decode$field, 'canOHKO', $elm$json$Json$Decode$bool),
								A2(
									$author$project$Decoders$andMap,
									...
									A2(
										...
										A2(
											$author$project$Decoders$andMap,
											A2($elm$json$Json$Decode$field, 'boxIndex', $elm$json$Json$Decode$int),
											$elm$json$Json$Decode$succeed($author$project$Types$BoxMatchupResult))))))))))));
var $author$project$Types$CalculationResult = F4(
...
var $author$project$Types$MoveResult = function (moveName) {
	return function (damage) {
		return function (damagePercent) {
			return function (critDamage) {
				return function (critDamagePercent) {
					return function (description) {
						return function (koChance) {
							return function (critKoChance) {
								return function (damageRolls) {
									return function (critDamageRolls) {
										return {critDamage: critDamage, critDamagePercent: critDamagePercent, critDamageRolls: critDamageRolls, critKoChance: critKoChance, damage: damage, damagePercent: damagePercent, damageRolls: damageRolls, description: description, koChance: koChance, moveName: moveName};
									};
								};
							};
						};
...
var $author$project$Decoders$moveResultDecoder = A2(
	$author$project$Decoders$andMap,
	A2(
		$elm$json$Json$Decode$field,
		'critDamageRolls',
	...
	A2(
		...
		A2(
			$author$project$Decoders$andMap,
			A2($elm$json$Json$Decode$field, 'critKoChance', $elm$json$Json$Decode$string),
			A2(
				$author$project$Decoders$andMap,
							...
							A2(
								...
								A2(
									...
									A2(
										...
										$elm$json$Json$Decode$succeed($author$project$Types$MoveResult)))))))))));
var $author$project$Decoders$calculationResultDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Types$CalculationResult,
	A2(
		$elm$json$Json$Decode$field,
		'attackerResults',
		$elm$json$Json$Decode$list($author$project$Decoders$moveResultDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'defenderResults',
		$elm$json$Json$Decode$list($author$project$Decoders$moveResultDecoder)),
...
var $author$project$Encoders$encodeSideConditions = function (side) {
...
var $author$project$Encoders$encodeField = function (field) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'attackerSide',
				$author$project$Encoders$encodeSideConditions(field.attackerSide)),
				_Utils_Tuple2(
				'defenderSide',
				$author$project$Encoders$encodeSideConditions(field.defenderSide))
			]));
};
var $author$project$Encoders$encodeMove = function (move) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Encoders$encodeStats = function (stats) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Encoders$encodePokemon = function (pokemon) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'evs',
				$author$project$Encoders$encodeStats(pokemon.evs)),
				_Utils_Tuple2(
				'ivs',
				$author$project$Encoders$encodeStats(pokemon.ivs)),
				_Utils_Tuple2(
				'boosts',
				$author$project$Encoders$encodeStats(pokemon.boosts)),
				_Utils_Tuple2(
				'status',
				...
				_Utils_Tuple2(
				'moves',
				A2($elm$json$Json$Encode$list, $author$project$Encoders$encodeMove, pokemon.moves))
			]));
};
var $author$project$Encoders$encodeCalculationRequest = function (model) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'attacker',
				$author$project$Encoders$encodePokemon(model.attacker)),
				_Utils_Tuple2(
				'defender',
				$author$project$Encoders$encodePokemon(model.defender)),
				_Utils_Tuple2(
				'moves',
				A2($elm$json$Json$Encode$list, $author$project$Encoders$encodeMove, model.attacker.moves)),
				_Utils_Tuple2(
				'field',
				$author$project$Encoders$encodeField(model.field))
			]));
};
...
var $author$project$Encoders$encodePokemonSource = function (maybeSource) {
	if (maybeSource.$ === 'Just') {
...
var $author$project$Encoders$encodeGameSaveData = function (data) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'team',
				A2($elm$json$Json$Encode$list, $author$project$Encoders$encodePokemon, data.team)),
				_Utils_Tuple2(
				'box',
				A2($elm$json$Json$Encode$list, $author$project$Encoders$encodePokemon, data.box)),
				_Utils_Tuple2(
				'attackerSource',
				$author$project$Encoders$encodePokemonSource(data.attackerSource)),
				_Utils_Tuple2(
				'attacker',
				function () {
					...
					if (_v0.$ === 'Just') {
						var pokemon = _v0.a;
						return $author$project$Encoders$encodePokemon(pokemon);
					} else {
						return $elm$json$Json$Encode$null;
					}
				}()),
				...
				'levelCap',
				function () {
					var _v2 = data.levelCap;
					if (_v2.$ === 'Just') {
						var cap = _v2.a;
						return $elm$json$Json$Encode$int(cap);
					} else {
						return $elm$json$Json$Encode$null;
					}
				}())
...
var $author$project$Encoders$encodeSettings = function (model) {
	var currentGameData = {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'gameData',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Encoders$encodeGameSaveData, updatedGameData))
			]));
};
...
var $author$project$Decoders$itemListDecoder = A2(
	$elm$json$Json$Decode$field,
	'items',
	$elm$json$Json$Decode$list($elm$json$Json$Decode$string));
var $author$project$Types$LearnsetData = F7(
	function (species, levelup, tm, tutor, egg, other, isAttacker) {
		return {egg: egg, isAttacker: isAttacker, levelup: levelup, other: other, species: species, tm: tm, tutor: tutor};
	});
var $elm$json$Json$Decode$map7 = _Json_map7;
var $author$project$Decoders$learnsetDecoder = A8(
	$elm$json$Json$Decode$map7,
	$author$project$Types$LearnsetData,
	...
	A2(
		...
		'other',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'isAttacker', $elm$json$Json$Decode$bool));
...
var $author$project$Types$MoveData = F6(
...
var $author$project$Decoders$moveListDecoder = A2(
	$elm$json$Json$Decode$field,
	'moves',
	$elm$json$Json$Decode$list(
		A7(
			$elm$json$Json$Decode$map6,
			$author$project$Types$MoveData,
...
var $author$project$Types$NatureData = F3(
	function (name, plus, minus) {
		return {minus: minus, name: name, plus: plus};
	});
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$oneOf = _Json_oneOf;
var $author$project$Decoders$natureListDecoder = A2(
	$elm$json$Json$Decode$field,
	'natures',
	$elm$json$Json$Decode$list(
		A4(
			$elm$json$Json$Decode$map3,
			$author$project$Types$NatureData,
			A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
...
var $author$project$Types$PokemonData = function (name) {
...
var $author$project$Decoders$pokemonDataDecoder = A2(
	$author$project$Decoders$andMap,
									...
									A2(
										...
										A2(
											...
											A2(
												...
												A2(
													$author$project$Decoders$andMap,
													A2($elm$json$Json$Decode$field, 'baseStats', $author$project$Decoders$statsDecoder),
													A2(
														$author$project$Decoders$andMap,
														A2(
															$elm$json$Json$Decode$field,
														...
														A2(
															$author$project$Decoders$andMap,
															A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
															$elm$json$Json$Decode$succeed($author$project$Types$PokemonData))))))))))))))));
var $author$project$Decoders$pokemonListDecoder = A2(
	$elm$json$Json$Decode$field,
	'pokemon',
	$elm$json$Json$Decode$list($author$project$Decoders$pokemonDataDecoder));
var $author$project$Main$requestBoxMatchup = _Platform_outgoingPort('requestBoxMatchup', $elm$core$Basics$identity);
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'isAttacker',
					$elm$json$Json$Encode$bool($.isAttacker)),
					_Utils_Tuple2(
					'species',
...
var $author$project$Types$Settings = F2(
...
var $author$project$Types$GameSaveData = F7(
	function (team, box, attackerSource, attacker, defender, selectedTrainerIndex, levelCap) {
		return {attacker: attacker, attackerSource: attackerSource, box: box, defender: defender, levelCap: levelCap, selectedTrainerIndex: selectedTrainerIndex, team: team};
	});
var $author$project$Types$PokemonState = function (species) {
...
var $author$project$Types$MoveState = F3(
	function (name, isCrit, hits) {
		return {hits: hits, isCrit: isCrit, name: name};
	});
var $author$project$Decoders$moveStateDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Types$MoveState,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
...
var $author$project$Decoders$pokemonDecoder = A2(
	...
	function (f) {
		return A2(
			...
			A2(
				$elm$json$Json$Decode$field,
				'moves',
				$elm$json$Json$Decode$list($author$project$Decoders$moveStateDecoder)));
	},
	A2(
		$elm$json$Json$Decode$andThen,
		function (f) {
						...
						function (f) {
							return A2(
								...
								$elm$json$Json$Decode$oneOf(
									_List_fromArray(
										[
											A2($elm$json$Json$Decode$field, 'boosts', $author$project$Decoders$statsDecoder),
											$elm$json$Json$Decode$succeed($author$project$Types$defaultStats)
										])));
						},
						A2(
							$elm$json$Json$Decode$andThen,
							function (f) {
								return A2(
									...
									$elm$json$Json$Decode$oneOf(
										_List_fromArray(
											[
												A2($elm$json$Json$Decode$field, 'ivs', $author$project$Decoders$statsDecoder),
												$elm$json$Json$Decode$succeed($author$project$Types$defaultIVs)
											])));
							},
							A2(
								$elm$json$Json$Decode$andThen,
								function (f) {
									return A2(
										...
										$elm$json$Json$Decode$oneOf(
											_List_fromArray(
												[
													A2($elm$json$Json$Decode$field, 'evs', $author$project$Decoders$statsDecoder),
													$elm$json$Json$Decode$succeed($author$project$Types$defaultStats)
												])));
								},
								A2(
										...
										A2(
											...
											A2(
												...
												A2(
													...
													$elm$json$Json$Decode$succeed($author$project$Types$PokemonState))))))))))))));
var $author$project$Decoders$pokemonSourceDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A3(
			$elm$json$Json$Decode$map2,
			F2(
				function (sourceType, index) {
					switch (sourceType) {
						case 'team':
							return $elm$core$Maybe$Just(
								$author$project$Types$FromTeam(index));
						case 'box':
							return $elm$core$Maybe$Just(
								$author$project$Types$FromBox(index));
						default:
							return $elm$core$Maybe$Nothing;
					}
				}),
...
var $author$project$Decoders$gameSaveDataDecoder = A8(
	$elm$json$Json$Decode$map7,
	$author$project$Types$GameSaveData,
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(
				$elm$json$Json$Decode$field,
				'team',
				$elm$json$Json$Decode$list($author$project$Decoders$pokemonDecoder)),
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'attackerSource', $author$project$Decoders$pokemonSourceDecoder),
				$elm$json$Json$Decode$succeed($elm$core$Maybe$Nothing)
			])),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$field,
				'attacker',
				A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $author$project$Decoders$pokemonDecoder)),
				$elm$json$Json$Decode$succeed($elm$core$Maybe$Nothing)
			])),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
...
var $author$project$Decoders$settingsDecoder = A3(
	$elm$json$Json$Decode$map2,
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$field,
				'gameData',
				$elm$json$Json$Decode$dict($author$project$Decoders$gameSaveDataDecoder)),
...
var $author$project$Types$TrainerEncounter = F7(
...
var $author$project$Types$TrainerPokemon = F8(
...
var $author$project$Decoders$trainerPokemonDecoder = A9(
	$elm$json$Json$Decode$map8,
	$author$project$Types$TrainerPokemon,
	A2($elm$json$Json$Decode$field, 'species', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'level', $elm$json$Json$Decode$int),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
	...
	A2(
		...
		'moves',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Decoders$trainerEncounterDecoder = A8(
	$elm$json$Json$Decode$map7,
	$author$project$Types$TrainerEncounter,
	...
	A2(
		$elm$json$Json$Decode$field,
		'team',
		$elm$json$Json$Decode$list($author$project$Decoders$trainerPokemonDecoder)));
var $author$project$Decoders$trainerDataDecoder = A2(
	$elm$json$Json$Decode$field,
	'encounters',
	$elm$json$Json$Decode$list($author$project$Decoders$trainerEncounterDecoder));
...
var $author$project$Main$updateAndCalculate = F2(
	function (updateFn, model) {
		...
		var saveCmd = $author$project$Main$saveToLocalStorage(
			$author$project$Encoders$encodeSettings(newModel));
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Encoders$encodeCalculationRequest(newModel)),
						saveCmd
			...
			switch (msg.$) {
				...
				case 'SetAttackerSpecies':
					...
					var learnsetCmd = (!$elm$core$String$isEmpty(species)) ? $author$project$Main$requestLearnset(
						{generation: model.generation, isAttacker: true, species: species}) : $elm$core$Platform$Cmd$none;
					var _v1 = A2(
				...
				case 'SetDefenderSpecies':
					var species = msg.a;
					var learnsetCmd = (!$elm$core$String$isEmpty(species)) ? $author$project$Main$requestLearnset(
						{generation: model.generation, isAttacker: false, species: species}) : $elm$core$Platform$Cmd$none;
					var _v2 = A2(
						$author$project$Main$updateAndCalculate,
						function (m) {
							...
							var modelWithAbility = _Utils_update(
								m,
								{
									attacker: _Utils_update(
										attacker,
										{ability: ability}),
									openDropdown: $elm$core$Maybe$Just($author$project$Types$AttackerAbilityDropdown)
								});
							...
							var modelWithAbility = _Utils_update(
								m,
								{
									defender: _Utils_update(
										defender,
										{ability: ability}),
									openDropdown: $elm$core$Maybe$Just($author$project$Types$DefenderAbilityDropdown)
								});
							return A2($author$project$Main$applyAbilityAutoTriggers, modelWithAbility, ability);
						},
						model);
							...
							var modelWithItem = _Utils_update(
								m,
								{
									attacker: _Utils_update(
										attacker,
										{item: item}),
									openDropdown: $elm$core$Maybe$Just($author$project$Types$AttackerItemDropdown)
								});
							...
							var modelWithItem = _Utils_update(
								m,
								{
									defender: _Utils_update(
										defender,
										{item: item}),
									openDropdown: $elm$core$Maybe$Just($author$project$Types$DefenderItemDropdown)
								});
				...
				case 'SetAttackerMove':
					...
					return A2(
						$author$project$Main$updateAndCalculate,
						function (m) {
							var dropdownId = function () {
								switch (index) {
									case 0:
										return $author$project$Types$AttackerMoveDropdown(0);
									case 1:
										return $author$project$Types$AttackerMoveDropdown(1);
									case 2:
										return $author$project$Types$AttackerMoveDropdown(2);
									default:
										return $author$project$Types$AttackerMoveDropdown(3);
								}
							}();
							var attacker = m.attacker;
							var moves = A2(
							...
							return _Utils_update(
								m,
								{
									attacker: _Utils_update(
										attacker,
										{moves: moves}),
									openDropdown: $elm$core$Maybe$Just(dropdownId)
								});
						},
						model);
					...
					return A2(
						...
						function (m) {
							var dropdownId = function () {
								switch (index) {
									case 0:
										return $author$project$Types$DefenderMoveDropdown(0);
									case 1:
										return $author$project$Types$DefenderMoveDropdown(1);
									case 2:
										return $author$project$Types$DefenderMoveDropdown(2);
									default:
										return $author$project$Types$DefenderMoveDropdown(3);
								}
							}();
							var defender = m.defender;
							var moves = A2(
				...
				case 'Calculate':
					...
					return shouldCalc ? _Utils_Tuple2(
						model,
						$author$project$Main$requestCalculation(
							$author$project$Encoders$encodeCalculationRequest(model))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				case 'ReceivedCalculation':
					var value = msg.a;
					var _v5 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$calculationResultDecoder, value);
					if (_v5.$ === 'Ok') {
						var result = _v5.a;
						...
						var _v6 = attackerFaster ? _Utils_Tuple2(
							$author$project$Types$AttackerMove,
							findHighestDamageIndex(result.attackerResults)) : _Utils_Tuple2(
							$author$project$Types$DefenderMove,
				...
				case 'ReceivedPokemonList':
					var value = msg.a;
					var _v8 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$pokemonListDecoder, value);
					if (_v8.$ === 'Ok') {
						var pokemonList = _v8.a;
						...
						return shouldCalc ? _Utils_Tuple2(
							newModel,
							$author$project$Main$requestCalculation(
								$author$project$Encoders$encodeCalculationRequest(newModel))) : _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
				...
				case 'ReceivedMoveList':
					var value = msg.a;
					var _v9 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$moveListDecoder, value);
					if (_v9.$ === 'Ok') {
						var moveList = _v9.a;
						return _Utils_Tuple2(
							_Utils_update(
				...
				case 'ReceivedItemList':
					var value = msg.a;
					var _v10 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$itemListDecoder, value);
					if (_v10.$ === 'Ok') {
						var itemList = _v10.a;
						return _Utils_Tuple2(
							_Utils_update(
				...
				case 'ReceivedAbilityList':
					var value = msg.a;
					var _v11 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$abilityListDecoder, value);
					if (_v11.$ === 'Ok') {
						var abilityList = _v11.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
				...
				case 'ReceivedNatureList':
					var value = msg.a;
					var _v12 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$natureListDecoder, value);
					if (_v12.$ === 'Ok') {
						var natureList = _v12.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
				...
				case 'ReceivedLearnset':
					var value = msg.a;
					var _v13 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$learnsetDecoder, value);
					if (_v13.$ === 'Ok') {
						var learnset = _v13.a;
						return learnset.isAttacker ? _Utils_Tuple2(
							_Utils_update(
								model,
								{
				...
				case 'LoadedSettings':
					var value = msg.a;
					var _v14 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$settingsDecoder, value);
					if (_v14.$ === 'Ok') {
						var settings = _v14.a;
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{allGameData: settings.gameData, attacker: loadedAttacker, attackerSource: loadedAttackerSource, box: loadedBox, defender: loadedDefender, generation: gen, levelCap: loadedLevelCap, loading: true, selectedGame: game, selectedTrainerIndex: loadedTrainerIndex, settingsLoaded: true, team: loadedTeam}),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Main$requestPokemonList(gen),
										...
										(!$elm$core$String$isEmpty(loadedAttacker.species)) ? $author$project$Main$requestLearnset(
										{generation: gen, isAttacker: true, species: loadedAttacker.species}) : $elm$core$Platform$Cmd$none,
										(!$elm$core$String$isEmpty(loadedDefender.species)) ? $author$project$Main$requestLearnset(
										{generation: gen, isAttacker: false, species: loadedDefender.species}) : $elm$core$Platform$Cmd$none
									])));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 'ReceivedAvailableGames':
					var value = msg.a;
					var _v15 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$availableGamesDecoder, value);
					if (_v15.$ === 'Ok') {
						var games = _v15.a;
						return _Utils_Tuple2(
							_Utils_update(
				...
				case 'ReceivedTrainerData':
					var value = msg.a;
					var _v16 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$trainerDataDecoder, value);
					if (_v16.$ === 'Ok') {
						var encounters = _v16.a;
						var filtered = A2($author$project$Main$filterEncounters, model.trainerSearchQuery, encounters);
						var defaultLevelCap = model.settingsLoaded ? model.levelCap : A2(
							$elm$core$Maybe$andThen,
							function (gymLeader) {
							...
							$elm$core$List$head(
								A2(
									$elm$core$List$filter,
									function (e) {
										return A2($elm$core$String$contains, 'Leader', e.trainerClass) || A2($elm$core$String$contains, 'Gym', e.trainerClass);
									},
									encounters)));
						var _v17 = function () {
							if (model.settingsLoaded) {
								...
								var _v18 = $elm$core$List$head(encounters);
								if (_v18.$ === 'Just') {
									var firstEncounter = _v18.a;
									var _v19 = $elm$core$List$head(firstEncounter.team);
									if (_v19.$ === 'Just') {
										var rivalPokemon = _v19.a;
						...
						var newAttacker = _v17.a;
						var newDefender = _v17.b;
						var newTrainerIndex = _v17.c;
						var newModel = _Utils_update(
							model,
							{attacker: newAttacker, defender: newDefender, filteredEncounters: filtered, levelCap: defaultLevelCap, selectedTrainerIndex: newTrainerIndex, trainerEncounters: encounters});
						var isValidSpecies = function (speciesName) {
							return A2(
								$elm$core$List$any,
								function (p) {
				...
				case 'SelectFromSearchResults':
					var encounter = msg.a;
					var _v20 = A2($author$project$Main$findEncounterIndex, encounter, model.trainerEncounters);
					if (_v20.$ === 'Just') {
						var index = _v20.a;
						var newModel = _Utils_update(
							model,
				...
				case 'LoadTrainerToDefender':
					...
					var _v21 = $author$project$Main$getSelectedEncounter(model);
					if (_v21.$ === 'Just') {
						var encounter = _v21.a;
						var _v22 = $elm$core$List$head(
							A2($elm$core$List$drop, pokemonIndex, encounter.team));
						if (_v22.$ === 'Just') {
							var trainerPokemon = _v22.a;
				...
				case 'AddToBox':
					var isValidSpecies = A2(
						$elm$core$List$any,
						function (p) {
							return _Utils_eq(p.name, model.attacker.species);
						},
						model.pokemonList);
					if (isValidSpecies) {
						...
						var newModel = _Utils_update(
							model,
							{
								attackerSource: $elm$core$Maybe$Just(
									$author$project$Types$FromBox(newIndex)),
								box: newBox
							});
						return _Utils_Tuple2(
							newModel,
				...
				case 'LoadFromBox':
					...
					if (_v23.$ === 'Just') {
						...
						var learnsetCmd = (!$elm$core$String$isEmpty(pokemon.species)) ? $author$project$Main$requestLearnset(
							{generation: model.generation, isAttacker: true, species: pokemon.species}) : $elm$core$Platform$Cmd$none;
						var _v24 = A2(
							$author$project$Main$updateAndCalculate,
							function (m) {
								return m;
					...
					var newSource = function () {
						...
						if ((_v25.$ === 'Just') && (_v25.a.$ === 'FromBox')) {
							...
							return _Utils_eq(sourceIndex, index) ? $elm$core$Maybe$Nothing : ((_Utils_cmp(sourceIndex, index) > 0) ? $elm$core$Maybe$Just(
								$author$project$Types$FromBox(sourceIndex - 1)) : model.attackerSource);
						} else {
					...
					if ($elm$core$List$length(model.team) >= 6) {
						...
						if (isValidSpecies) {
							...
							var newModel = _Utils_update(
								...
								{
									attackerSource: $elm$core$Maybe$Just(
										$author$project$Types$FromTeam(newIndex)),
									team: newTeam
								});
							return _Utils_Tuple2(
								newModel,
				...
				case 'RemoveFromTeam':
					...
					var newSource = function () {
						var _v28 = model.attackerSource;
						if ((_v28.$ === 'Just') && (_v28.a.$ === 'FromTeam')) {
							var sourceIndex = _v28.a.a;
							return _Utils_eq(sourceIndex, index) ? $elm$core$Maybe$Nothing : ((_Utils_cmp(sourceIndex, index) > 0) ? $elm$core$Maybe$Just(
								$author$project$Types$FromTeam(sourceIndex - 1)) : model.attackerSource);
						} else {
							return model.attackerSource;
						}
					}();
						...
						if ($elm$core$List$length(model.team) >= 6) {
							...
							var newTeam = _Utils_ap(
								...
								_List_fromArray(
									[pokemon]));
							var newSource = function () {
								var _v30 = model.attackerSource;
								if ((_v30.$ === 'Just') && (_v30.a.$ === 'FromBox')) {
									var sourceIndex = _v30.a.a;
									return _Utils_eq(sourceIndex, boxIndex) ? $elm$core$Maybe$Just(
										$author$project$Types$FromTeam(
				...
				case 'MoveToBox':
					...
					if (_v31.$ === 'Just') {
						...
						var newSource = function () {
							var _v32 = model.attackerSource;
							if ((_v32.$ === 'Just') && (_v32.a.$ === 'FromTeam')) {
								var sourceIndex = _v32.a.a;
								return _Utils_eq(sourceIndex, teamIndex) ? $elm$core$Maybe$Just(
									$author$project$Types$FromBox(
					...
					if (_v39.$ === 'Just') {
						...
						var newTeam = _Utils_ap(
							...
							_Utils_ap(
								...
								A2($elm$core$List$drop, teamIndex + 1, model.team)));
						var newAttacker = function () {
							var _v40 = model.attackerSource;
							if ((_v40.$ === 'Just') && (_v40.a.$ === 'FromTeam')) {
								var sourceIndex = _v40.a.a;
					...
					if (_v41.$ === 'Just') {
						...
						var newBox = _Utils_ap(
							...
							_Utils_ap(
								...
								A2($elm$core$List$drop, boxIndex + 1, model.box)));
						var newAttacker = function () {
							var _v42 = model.attackerSource;
							if ((_v42.$ === 'Just') && (_v42.a.$ === 'FromBox')) {
								var sourceIndex = _v42.a.a;
				...
				case 'DragOver':
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				case 'DropOnTeam':
					var _v43 = model.dragState;
					if (_v43.$ === 'Just') {
						var source = _v43.a.source;
						var index = _v43.a.index;
				...
				case 'DropOnBox':
					var _v45 = model.dragState;
					if (_v45.$ === 'Just') {
						var source = _v45.a.source;
						var index = _v45.a.index;
				...
				case 'CloseDropdown':
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 'RequestResetGameData':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{showResetConfirmDialog: true}),
						$elm$core$Platform$Cmd$none);
				case 'CancelResetGameData':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{showResetConfirmDialog: false}),
						$elm$core$Platform$Cmd$none);
				case 'ConfirmResetGameData':
					var emptyGameData = {attacker: $elm$core$Maybe$Nothing, attackerSource: $elm$core$Maybe$Nothing, box: _List_Nil, defender: $elm$core$Maybe$Nothing, levelCap: $elm$core$Maybe$Nothing, selectedTrainerIndex: 0, team: _List_Nil};
					var updatedAllGameData = A3($elm$core$Dict$insert, model.selectedGame, emptyGameData, model.allGameData);
					var resetModel = _Utils_update(
						model,
						{allGameData: updatedAllGameData, attacker: $author$project$Types$defaultAttacker, attackerSource: $elm$core$Maybe$Nothing, box: _List_Nil, defender: $author$project$Types$defaultDefender, selectedTrainerIndex: 0, showResetConfirmDialog: false, team: _List_Nil});
					return _Utils_Tuple2(
						resetModel,
						$author$project$Main$saveToLocalStorage(
							$author$project$Encoders$encodeSettings(resetModel)));
				case 'SetLevelCap':
					var maybeCap = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{levelCap: maybeCap}),
						$elm$core$Platform$Cmd$none);
				case 'ApplyLevelCapToAll':
					var _v47 = model.levelCap;
					if (_v47.$ === 'Nothing') {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						var cap = _v47.a;
						...
						var updatedBox = A2(
							...
							model.box);
						var updatedAttacker = function () {
							var _v48 = model.attackerSource;
							if (_v48.$ === 'Just') {
								var currentAttacker = model.attacker;
								return _Utils_update(
									currentAttacker,
									{level: cap});
							} else {
						...
						return A2(
							...
							function (m) {
								return _Utils_update(
									m,
									{attacker: updatedAttacker, box: updatedBox, team: updatedTeam});
							},
							model);
					}
				case 'ToggleFieldConditionsDropdown':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{fieldConditionsDropdownOpen: !model.fieldConditionsDropdownOpen}),
						$elm$core$Platform$Cmd$none);
				case 'CalculateBoxMatchups':
					var isValidDefender = (!$elm$core$String$isEmpty(model.defender.species)) && A2(
						$elm$core$List$any,
						function (p) {
							return _Utils_eq(p.name, model.defender.species);
						},
						model.pokemonList);
					return (isValidDefender && (!$elm$core$List$isEmpty(model.box))) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{boxMatchupResults: $elm$core$Dict$empty}),
						$elm$core$Platform$Cmd$batch(
							A2(
								$elm$core$List$indexedMap,
								F2(
									function (index, boxPokemon) {
										return $author$project$Main$requestBoxMatchup(
											$elm$json$Json$Encode$object(
												_List_fromArray(
													[
														...
														_Utils_Tuple2(
														'attacker',
														$author$project$Encoders$encodePokemon(boxPokemon)),
														_Utils_Tuple2(
														'defender',
														$author$project$Encoders$encodePokemon(model.defender)),
														_Utils_Tuple2(
								...
								model.box))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				default:
					var value = msg.a;
					var _v49 = A2($elm$json$Json$Decode$decodeValue, $author$project$Decoders$boxMatchupResultDecoder, value);
					if (_v49.$ === 'Ok') {
						var result = _v49.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									boxMatchupResults: A3($elm$core$Dict$insert, result.boxIndex, result, model.boxMatchupResults)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						var error = _v49.a;
...
var $author$project$Main$CancelResetGameData = {$: 'CancelResetGameData'};
var $author$project$Main$CloseDropdown = {$: 'CloseDropdown'};
var $author$project$Main$ConfirmResetGameData = {$: 'ConfirmResetGameData'};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/709.png'),
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('input input-bordered input-xs w-20')
								]),
							_List_Nil)
						])) : $elm$html$Html$text(''),
					(generation >= 3) ? A2(
					...
					if (generation >= 3) {
						...
						var dropdownId = isAttacker ? $author$project$Types$AttackerAbilityDropdown : $author$project$Types$DefenderAbilityDropdown;
						return A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('btn btn-sm btn-primary w-full mt-4')
						]),
					_List_fromArray(
						[
...
var $author$project$Main$isSoundMove = function (moveName) {
	return A2(
		$elm$core$List$member,
		moveName,
		_List_fromArray(
			['Boomburst', 'Bug Buzz', 'Chatter', 'Clanging Scales', 'Clangorous Soul', 'Clangorous Soulblaze', 'Confide', 'Disarming Voice', 'Echoed Voice', 'Grass Whistle', 'Growl', 'Heal Bell', 'Hyper Voice', 'Metal Sound', 'Noble Roar', 'Overdrive', 'Parting Shot', 'Perish Song', 'Relic Song', 'Roar', 'Round', 'Screech', 'Shadow Panic', 'Sing', 'Snarl', 'Snore', 'Sparkling Aria', 'Supersonic', 'Throat Chop', 'Uproar']));
};
var $author$project$Main$getEffectiveMoveType = F3(
	function (moveName, moveType, ability) {
		switch (ability) {
			case 'Aerilate':
				return (moveType === 'Normal') ? 'Flying' : moveType;
			case 'Galvanize':
				return (moveType === 'Normal') ? 'Electric' : moveType;
			case 'Pixilate':
				return (moveType === 'Normal') ? 'Fairy' : moveType;
			case 'Refrigerate':
				return (moveType === 'Normal') ? 'Ice' : moveType;
			case 'Liquid Voice':
				return $author$project$Main$isSoundMove(moveName) ? 'Water' : moveType;
			case 'Normalize':
				return 'Normal';
			default:
				return moveType;
...
var $author$project$Main$getFilteredMoveList = F2(
	function (maybeLearnset, allMoves) {
		if (maybeLearnset.$ === 'Just') {
			...
			var sortedLevelupMoves = A2(
				$elm$core$List$map,
				$elm$core$Tuple$first,
				A2($elm$core$List$sortBy, $elm$core$Tuple$second, learnset.levelup));
				...
				function (moveName) {
					return $elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (m) {
								return _Utils_eq(m.name, moveName);
							},
							allMoves));
				},
				learnableMoves);
...
var $author$project$Main$getMoveSource = F2(
	function (maybeLearnset, moveName) {
		if (maybeLearnset.$ === 'Just') {
			var learnset = maybeLearnset.a;
			var levelupMove = $elm$core$List$head(
				A2(
					$elm$core$List$filter,
					function (_v3) {
						var name = _v3.a;
						return _Utils_eq(name, moveName);
					},
					learnset.levelup));
			if (levelupMove.$ === 'Just') {
				var _v2 = levelupMove.a;
				var level = _v2.b;
				return (!level) ? ' [Evolve]' : (' [Level ' + ($elm$core$String$fromInt(level) + ']'));
			} else {
				return A2($elm$core$List$member, moveName, learnset.tm) ? ' [TM]' : (A2($elm$core$List$member, moveName, learnset.tutor) ? ' [Tutor]' : (A2($elm$core$List$member, moveName, learnset.egg) ? ' [Egg]' : (A2($elm$core$List$member, moveName, learnset.other) ? ' [Other]' : '')));
			}
		} else {
			return '';
		}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mb-3 form-control')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('number'),
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromInt(model.attacker.level)),
								$elm$html$Html$Events$onInput(
								function (v) {
									return $author$project$Main$SetAttackerLevel(
										A2(
											$elm$core$Maybe$withDefault,
											50,
											$elm$core$String$toInt(v)));
							...
							return A2(
								...
								_List_fromArray(
									[
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Attributes$class('input input-bordered input-xs flex-1'),
														$elm$html$Html$Events$onFocus(
														$author$project$Main$ToggleDropdown($author$project$Types$AttackerItemDropdown))
													]),
												_List_Nil),
												A2(
												$elm$html$Html$button,
										...
										_Utils_eq(
										model.openDropdown,
										$elm$core$Maybe$Just($author$project$Types$AttackerItemDropdown)) ? A2(
										$elm$html$Html$div,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('absolute z-50 mt-1 w-full max-h-60 overflow-y-auto bg-base-100 border border-base-300 rounded shadow-lg')
							...
							return A2(
								...
								_List_fromArray(
									[
												...
												_List_fromArray(
													[
														...
														$author$project$Main$ToggleDropdown(
															$author$project$Types$AttackerMoveDropdown(index)))
													]),
												_List_Nil),
												A2(
												$elm$html$Html$button,
										...
										if (moveData.$ === 'Just') {
											var data = moveData.a;
											var effectiveType = A3($author$project$Main$getEffectiveMoveType, move.name, data.moveType, model.attacker.ability);
											var typeDisplay = (!_Utils_eq(effectiveType, data.moveType)) ? (effectiveType + (' (' + (data.moveType + (' → ' + (effectiveType + ')'))))) : effectiveType;
											return A2(
												$elm$html$Html$div,
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														typeDisplay + (' • ' + (data.category + (' • BP: ' + (((data.basePower > 0) ? $elm$core$String$fromInt(data.basePower) : '—') + (' • Acc: ' + ((data.accuracy < 100) ? ($elm$core$String$fromInt(data.accuracy) + '%') : '—')))))))
													]));
										} else {
											return $elm$html$Html$text('');
										}
...
var $author$project$Main$CalculateBoxMatchups = {$: 'CalculateBoxMatchups'};
var $author$project$Types$DragFromBox = {$: 'DragFromBox'};
var $author$project$Types$DragFromTeam = {$: 'DragFromTeam'};
...
var $author$project$Types$BoxEvolutionDropdown = function (a) {
	return {$: 'BoxEvolutionDropdown', a: a};
};
var $author$project$Types$BoxFormDropdown = function (a) {
...
var $author$project$Main$getBoxPokemonBorderColor = function (maybeResult) {
	if (maybeResult.$ === 'Nothing') {
		return 'border-transparent';
	} else {
		var result = maybeResult.a;
		return (result.canOHKO && result.getsOHKOd) ? 'border-green-500' : ((result.mightOHKO && result.mightGetOHKOd) ? 'border-orange-500' : (result.getsOHKOd ? 'border-red-500' : (result.mightGetOHKOd ? 'border-orange-500' : (result.canOHKO ? 'border-yellow-400' : (result.mightOHKO ? 'border-yellow-600' : (result.isHardCounter ? 'border-cyan-500' : (result.isWall ? 'border-fuchsia-500' : ((_Utils_cmp(result.attackerSpeed, result.defenderSpeed) > 0) ? 'border-blue-500' : (_Utils_eq(result.attackerSpeed, result.defenderSpeed) ? 'border-purple-500' : 'border-gray-900')))))))));
	}
};
var $author$project$Main$isRegionalForm = function (formName) {
	return A2($elm$core$String$contains, '-Alola', formName) || (A2($elm$core$String$contains, '-Galar', formName) || (A2($elm$core$String$contains, '-Hisui', formName) || A2($elm$core$String$contains, '-Paldea', formName)));
};
var $author$project$Main$getNonRegionalForms = function (forms) {
	return A2(
		$elm$core$List$filter,
		function (form) {
			return !$author$project$Main$isRegionalForm(form);
		},
		forms);
};
	...
	function (model, index, pokemon) {
		var pokemonData = $elm$core$List$head(
			A2(
				...
				model.pokemonList));
		var matchupResult = A2($elm$core$Dict$get, index, model.boxMatchupResults);
		...
		var borderColor = isSelected ? 'border-primary' : $author$project$Main$getBoxPokemonBorderColor(matchupResult);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(
					isSelected ? ('flex items-center justify-between p-2 bg-base-300 rounded cursor-pointer border-2 ' + borderColor) : ('flex items-center justify-between p-2 bg-base-300 rounded cursor-pointer border-2 ' + (borderColor + ' hover:border-primary'))),
					$elm$html$Html$Events$onClick(
					...
					'dragstart',
					$elm$json$Json$Decode$succeed(
						A2($author$project$Main$DragStart, $author$project$Types$DragFromBox, index))),
					A2(
					$elm$html$Html$Events$on,
					'dragend',
				...
				[
					...
					_List_fromArray(
						[
										...
										return A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															...
															$elm$json$Json$Decode$succeed(
																_Utils_Tuple2(
																	$author$project$Main$ToggleDropdown(
																		$author$project$Types$BoxEvolutionDropdown(index)),
																	true)))
														]),
													_List_fromArray(
														[
													...
													model.openDropdown,
													$elm$core$Maybe$Just(
														$author$project$Types$BoxEvolutionDropdown(index))) ? A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
							...
							if (pokemonData.$ === 'Just') {
								var data = pokemonData.a;
								var battleForms = $author$project$Main$getNonRegionalForms(data.otherFormes);
								return (!$elm$core$List$isEmpty(battleForms)) ? A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('relative')
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													...
													$elm$json$Json$Decode$succeed(
														_Utils_Tuple2(
															$author$project$Main$ToggleDropdown(
																$author$project$Types$BoxFormDropdown(index)),
															true)))
												]),
											_List_fromArray(
												[
											...
											model.openDropdown,
											$elm$core$Maybe$Just(
												$author$project$Types$BoxFormDropdown(index))) ? A2(
											$elm$html$Html$div,
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('absolute z-50 right-0 mt-1 bg-base-100 border border-base-300 rounded shadow-lg')
											...
											A2(
												...
												battleForms)) : $elm$html$Html$text('')
										])) : $elm$html$Html$text('');
							} else {
								return $elm$html$Html$text('');
							}
...
var $author$project$Types$TeamEvolutionDropdown = function (a) {
	return {$: 'TeamEvolutionDropdown', a: a};
};
var $author$project$Types$TeamFormDropdown = function (a) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'dragstart',
					$elm$json$Json$Decode$succeed(
						A2($author$project$Main$DragStart, $author$project$Types$DragFromTeam, index))),
					A2(
					$elm$html$Html$Events$on,
					'dragend',
					$elm$json$Json$Decode$succeed($author$project$Main$DragEnd))
										...
										return A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															...
															$elm$json$Json$Decode$succeed(
																_Utils_Tuple2(
																	$author$project$Main$ToggleDropdown(
																		$author$project$Types$TeamEvolutionDropdown(index)),
																	true)))
														]),
													_List_fromArray(
														[
													...
													model.openDropdown,
													$elm$core$Maybe$Just(
														$author$project$Types$TeamEvolutionDropdown(index))) ? A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('absolute z-50 right-0 mt-1 bg-base-100 border border-base-300 rounded shadow-lg')
								...
								return (!$elm$core$List$isEmpty(battleForms)) ? A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													...
													$elm$json$Json$Decode$succeed(
														_Utils_Tuple2(
															$author$project$Main$ToggleDropdown(
																$author$project$Types$TeamFormDropdown(index)),
															true)))
												]),
											_List_fromArray(
												[
											...
											model.openDropdown,
											$elm$core$Maybe$Just(
												$author$project$Types$TeamFormDropdown(index))) ? A2(
											$elm$html$Html$div,
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('absolute z-50 right-0 mt-1 bg-base-100 border border-base-300 rounded shadow-lg')
...
var $author$project$Main$viewTeamBoxSection = function (model) {
	var isDraggingOverTeam = function () {
		...
		if (_v1.$ === 'Just') {
			...
			return _Utils_eq(source, $author$project$Types$DragFromBox);
		} else {
			return false;
		}
	}();
	var isDraggingOverBox = function () {
		...
		if (_v0.$ === 'Just') {
			...
			return _Utils_eq(source, $author$project$Types$DragFromTeam);
		} else {
			return false;
		}
	}();
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('flex items-center gap-2 text-left')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$CalculateBoxMatchups),
												$elm$html$Html$Attributes$class('btn btn-xs btn-outline btn-info'),
												$elm$html$Html$Attributes$disabled(
												$elm$core$List$isEmpty(model.box) || $elm$core$String$isEmpty(model.defender.species))
											]),
										_List_fromArray(
											[
...
var $author$project$Main$calculateMaxHP = F2(
	function (pokemon, pokemonList) {
		...
		return ($elm$core$Basics$floor(((((2 * baseHP) + iv) + ((ev / 4) | 0)) * level) / 100) + level) + 10;
	});
var $author$project$Main$calculateCurrentHP = F2(
	function (pokemon, pokemonList) {
		var percentage = pokemon.curHP / 100;
		var maxHP = A2($author$project$Main$calculateMaxHP, pokemon, pokemonList);
		return $elm$core$Basics$floor(maxHP * percentage);
	});
var $elm$html$Html$datalist = _VirtualDom_node('datalist');
var $author$project$Main$viewBattleStateSection = F5(
	function (title, pokemon, generation, pokemonList, isAttacker) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('text-xs w-16 text-right')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-xs text-base-content/60 mt-1')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(
									'≈ ' + ($elm$core$String$fromInt(
										A2($author$project$Main$calculateCurrentHP, pokemon, pokemonList)) + (' / ' + ($elm$core$String$fromInt(
										A2($author$project$Main$calculateMaxHP, pokemon, pokemonList)) + ' HP'))))
								]))
						])),
					A2(
					$elm$html$Html$div,
...
var $author$project$Main$viewBattleStatesContent = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A5($author$project$Main$viewBattleStateSection, 'Attacker', model.attacker, model.generation, model.pokemonList, true),
				A5($author$project$Main$viewBattleStateSection, 'Defender', model.defender, model.generation, model.pokemonList, false)
			]));
};
...
var $author$project$Main$getWeatherTerrainGradient = F2(
	function (weather, terrain) {
		...
		return ((!$elm$core$String$isEmpty(weather)) && (!$elm$core$String$isEmpty(terrain))) ? ('linear-gradient(to bottom, ' + (weatherColor + (', ' + (terrainColor + ')')))) : ((!$elm$core$String$isEmpty(weather)) ? ('linear-gradient(to bottom, ' + (weatherColor + (', ' + (weatherColor + ')')))) : ((!$elm$core$String$isEmpty(terrain)) ? ('linear-gradient(to bottom, ' + (terrainColor + (', ' + (terrainColor + ')')))) : ''));
	});
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-xs text-base-content/60 mb-1')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('Normal Damage')
												])),
											A2(
											$elm$html$Html$div,
											_List_fromArray(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-xs text-warning')
												]),
											_List_fromArray(
												[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-xl font-bold text-warning mb-1')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(
													$author$project$Main$formatDamagePercent(moveResult.critDamagePercent))
												])),
											(!$elm$core$String$isEmpty(moveResult.critKoChance)) ? A2(
											$elm$html$Html$div,
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-xs text-warning')
											...
											_List_fromArray(
												[
													$elm$html$Html$text(moveResult.critKoChance)
												])) : $elm$html$Html$text('')
										])),
									A2(
									$elm$html$Html$div,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Normal Rolls')
												])),
											A2(
											$elm$html$Html$div,
											_List_fromArray(
											...
											_List_fromArray(
												[
													...
													A2(
														$elm$core$String$join,
														', ',
														A2($elm$core$List$map, $elm$core$String$fromInt, moveResult.critDamageRolls)))
												]))
										]))
								]));
					} else {
...
var $author$project$Main$viewMoveButtonColumn = F9(
	function (moveList, pokemonList, pokemonName, results, mySpeed, theirSpeed, source, selectedSource, selectedIndex) {
		var validResults = A2(
			$elm$core$List$filter,
			function (result) {
		...
		var pokemonData = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (p) {
					return _Utils_eq(p.name, pokemonName);
				},
				pokemonList));
		var isSlower = _Utils_cmp(mySpeed, theirSpeed) < 0;
		var isAttacker = _Utils_eq(source, $author$project$Types$AttackerMove);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					A2(
						...
						F2(
							function (index, result) {
								var normalDamageText = $author$project$Main$formatDamagePercent(result.damagePercent);
								var isSelected = _Utils_eq(selectedSource, source) && _Utils_eq(selectedIndex, index);
								var critDamageText = $author$project$Main$formatDamagePercent(result.critDamagePercent);
								return A2(
									$elm$html$Html$button,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-xs text-base-content/60 mt-0.5')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(normalDamageText)
												])),
											A2(
											$elm$html$Html$div,
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('text-xs text-warning mt-0.5')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('Crit: ' + critDamageText)
												]))
										]));
							}),
						validResults))
...
var $author$project$Main$viewDamageResultsPanel = function (model) {
	var gradient = A2($author$project$Main$getWeatherTerrainGradient, model.field.weather, model.field.terrain);
	var backgroundStyle = $elm$core$String$isEmpty(gradient) ? _List_Nil : _List_fromArray(
		[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mb-4 flex flex-wrap gap-3 items-center border-b border-base-300 pb-3')
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('label-text text-xs font-semibold')
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('select select-bordered select-xs w-28')
									]),
								_List_fromArray(
									[
										A2(
									...
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$value(''),
												$elm$html$Html$Attributes$selected(
												$elm$core$String$isEmpty(model.field.weather))
											]),
										_List_fromArray(
											[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('select select-bordered select-xs w-32')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$value(''),
												$elm$html$Html$Attributes$selected(
												$elm$core$String$isEmpty(model.field.terrain))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('None')
				...
				if (_v0.$ === 'Nothing') {
					...
					return A2(
						...
						_List_fromArray(
							[
								A9($author$project$Main$viewMoveButtonColumn, model.moveList, model.pokemonList, model.attacker.species, result.attackerResults, result.attackerSpeed, result.defenderSpeed, $author$project$Types$AttackerMove, model.selectedMoveSource, model.selectedMoveIndex),
								...
								A9($author$project$Main$viewMoveButtonColumn, model.moveList, model.pokemonList, model.defender.species, result.defenderResults, result.defenderSpeed, result.attackerSpeed, $author$project$Types$DefenderMove, model.selectedMoveSource, model.selectedMoveIndex)
							]));
				}
			}()
			]));
...
var $author$project$Main$ApplyLevelCapToAll = {$: 'ApplyLevelCapToAll'};
...
var $author$project$Main$RequestResetGameData = {$: 'RequestResetGameData'};
var $author$project$Main$SelectFromSearchResults = function (a) {
	return {$: 'SelectFromSearchResults', a: a};
};
var $author$project$Main$SetLevelCap = function (a) {
	return {$: 'SetLevelCap', a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
										...
										function (index, tp) {
											var pokemonData = $elm$core$List$head(
												A2(
													$elm$core$List$filter,
													function (p) {
														return _Utils_eq(p.name, tp.species);
													},
													model.pokemonList));
											return A2(
												$elm$html$Html$button,
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mt-4 pt-3 border-t border-base-300')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-xs font-semibold text-primary mb-2')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Level Cap')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Set a level cap for all your Pokémon (useful for ROM hacks with level caps)')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										A2(
											$elm$core$Maybe$withDefault,
											'',
											A2($elm$core$Maybe$map, $elm$core$String$fromInt, model.levelCap))),
										$elm$html$Html$Events$onInput(
										function (v) {
											return $elm$core$String$isEmpty(v) ? $author$project$Main$SetLevelCap($elm$core$Maybe$Nothing) : $author$project$Main$SetLevelCap(
												$elm$core$String$toInt(v));
										}),
										$elm$html$Html$Attributes$placeholder('No cap'),
										$elm$html$Html$Attributes$min('1'),
										$elm$html$Html$Attributes$max('100'),
										$elm$html$Html$Attributes$class('input input-bordered input-xs w-20')
									]),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$ApplyLevelCapToAll),
										$elm$html$Html$Attributes$class('btn btn-xs btn-primary flex-1'),
										$elm$html$Html$Attributes$disabled(
										_Utils_eq(model.levelCap, $elm$core$Maybe$Nothing)),
										$elm$html$Html$Attributes$title('Set all team and box Pokémon to this level')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Apply to All')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mt-3 pt-3 border-t border-base-300')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$RequestResetGameData),
								$elm$html$Html$Attributes$class('btn btn-xs btn-error w-full'),
								$elm$html$Html$Attributes$title('Reset all data for this game (team, box, progress)')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('🚚 Reset Game Data')
							]))
					]))
			]));
};
...
var $author$project$Main$ToggleFieldConditionsDropdown = {$: 'ToggleFieldConditionsDropdown'};
var $author$project$Main$SetAttackerSideAuroraVeil = function (a) {
	return {$: 'SetAttackerSideAuroraVeil', a: a};
};
var $author$project$Main$SetAttackerSideHelpingHand = function (a) {
	return {$: 'SetAttackerSideHelpingHand', a: a};
};
...
var $author$project$Main$SetAttackerSideSpikes = function (a) {
	return {$: 'SetAttackerSideSpikes', a: a};
};
...
var $author$project$Main$SetDefenderSideAuroraVeil = function (a) {
	return {$: 'SetDefenderSideAuroraVeil', a: a};
};
var $author$project$Main$SetDefenderSideHelpingHand = function (a) {
	return {$: 'SetDefenderSideHelpingHand', a: a};
};
...
var $author$project$Main$SetDefenderSideSpikes = function (a) {
	return {$: 'SetDefenderSideSpikes', a: a};
};
...
var $author$project$Main$SetFieldGravity = function (a) {
	return {$: 'SetFieldGravity', a: a};
};
var $author$project$Main$viewConditionPill = F2(
	function (label, removeMsg) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('badge badge-primary gap-1 py-3 px-2')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('text-xs font-bold hover:text-error ml-1'),
							$elm$html$Html$Attributes$title('Remove condition')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('×')
...
var $author$project$Main$viewActiveConditionPills = function (model) {
	var gravityPill = model.field.isGravity ? _List_fromArray(
		[
			A2(
			$author$project$Main$viewConditionPill,
			'Gravity',
			$author$project$Main$SetFieldGravity(false))
		]) : _List_Nil;
	var defenderSidePills = A2(
		$elm$core$List$filterMap,
		$elm$core$Basics$identity,
		_List_fromArray(
			[
				model.field.defenderSide.isReflect ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Reflect (D)',
					$author$project$Main$SetDefenderSideReflect(false))) : $elm$core$Maybe$Nothing,
				model.field.defenderSide.isLightScreen ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Light Screen (D)',
					$author$project$Main$SetDefenderSideLightScreen(false))) : $elm$core$Maybe$Nothing,
				model.field.defenderSide.isAuroraVeil ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Aurora Veil (D)',
					$author$project$Main$SetDefenderSideAuroraVeil(false))) : $elm$core$Maybe$Nothing,
				model.field.defenderSide.isTailwind ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Tailwind (D)',
					$author$project$Main$SetDefenderSideTailwind(false))) : $elm$core$Maybe$Nothing,
				model.field.defenderSide.isHelpingHand ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Helping Hand (D)',
					$author$project$Main$SetDefenderSideHelpingHand(false))) : $elm$core$Maybe$Nothing,
				model.field.defenderSide.isSteathRock ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Stealth Rock (D)',
					$author$project$Main$SetDefenderSideStealthRock(false))) : $elm$core$Maybe$Nothing,
				(model.field.defenderSide.spikes > 0) ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Spikes ' + ($elm$core$String$fromInt(model.field.defenderSide.spikes) + ' (D)'),
					$author$project$Main$SetDefenderSideSpikes(0))) : $elm$core$Maybe$Nothing
			]));
	var attackerSidePills = A2(
		$elm$core$List$filterMap,
		$elm$core$Basics$identity,
		_List_fromArray(
			[
				model.field.attackerSide.isReflect ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Reflect (A)',
					$author$project$Main$SetAttackerSideReflect(false))) : $elm$core$Maybe$Nothing,
				model.field.attackerSide.isLightScreen ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Light Screen (A)',
					$author$project$Main$SetAttackerSideLightScreen(false))) : $elm$core$Maybe$Nothing,
				model.field.attackerSide.isAuroraVeil ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Aurora Veil (A)',
					$author$project$Main$SetAttackerSideAuroraVeil(false))) : $elm$core$Maybe$Nothing,
				model.field.attackerSide.isTailwind ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Tailwind (A)',
					$author$project$Main$SetAttackerSideTailwind(false))) : $elm$core$Maybe$Nothing,
				model.field.attackerSide.isHelpingHand ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Helping Hand (A)',
					$author$project$Main$SetAttackerSideHelpingHand(false))) : $elm$core$Maybe$Nothing,
				model.field.attackerSide.isSteathRock ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Stealth Rock (A)',
					$author$project$Main$SetAttackerSideStealthRock(false))) : $elm$core$Maybe$Nothing,
				(model.field.attackerSide.spikes > 0) ? $elm$core$Maybe$Just(
				A2(
					$author$project$Main$viewConditionPill,
					'Spikes ' + ($elm$core$String$fromInt(model.field.attackerSide.spikes) + ' (A)'),
					$author$project$Main$SetAttackerSideSpikes(0))) : $elm$core$Maybe$Nothing
			]));
	return _Utils_ap(
		gravityPill,
		_Utils_ap(attackerSidePills, defenderSidePills));
};
var $author$project$Main$viewConditionOption = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class(
					'w-full text-left px-2 py-1 text-xs hover:bg-base-300 rounded' + (isActive ? ' bg-primary text-primary-content' : ''))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(label)
...
var $author$project$Main$viewFieldConditionsDropdownMenu = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-xs font-semibold text-primary mb-1')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Field Effects')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A3(
								$author$project$Main$viewConditionOption,
								'Gravity',
								$author$project$Main$SetFieldGravity(true),
								model.field.isGravity)
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Attacker Side')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$viewConditionOption,
								'Reflect',
								$author$project$Main$SetAttackerSideReflect(true),
								model.field.attackerSide.isReflect),
								A3(
								$author$project$Main$viewConditionOption,
								'Light Screen',
								$author$project$Main$SetAttackerSideLightScreen(true),
								model.field.attackerSide.isLightScreen),
								A3(
								$author$project$Main$viewConditionOption,
								'Aurora Veil',
								$author$project$Main$SetAttackerSideAuroraVeil(true),
								model.field.attackerSide.isAuroraVeil),
								A3(
								$author$project$Main$viewConditionOption,
								'Tailwind',
								$author$project$Main$SetAttackerSideTailwind(true),
								model.field.attackerSide.isTailwind),
								A3(
								$author$project$Main$viewConditionOption,
								'Helping Hand',
								$author$project$Main$SetAttackerSideHelpingHand(true),
								model.field.attackerSide.isHelpingHand),
								A3(
								$author$project$Main$viewConditionOption,
								'Stealth Rock',
								$author$project$Main$SetAttackerSideStealthRock(true),
								model.field.attackerSide.isSteathRock),
								A3(
								$author$project$Main$viewConditionOption,
								'Spikes (1 layer)',
								$author$project$Main$SetAttackerSideSpikes(1),
								model.field.attackerSide.spikes === 1),
								A3(
								$author$project$Main$viewConditionOption,
								'Spikes (2 layers)',
								$author$project$Main$SetAttackerSideSpikes(2),
								model.field.attackerSide.spikes === 2),
								A3(
								$author$project$Main$viewConditionOption,
								'Spikes (3 layers)',
								$author$project$Main$SetAttackerSideSpikes(3),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Defender Side')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$viewConditionOption,
								'Reflect',
								$author$project$Main$SetDefenderSideReflect(true),
								model.field.defenderSide.isReflect),
								A3(
								$author$project$Main$viewConditionOption,
								'Light Screen',
								$author$project$Main$SetDefenderSideLightScreen(true),
								model.field.defenderSide.isLightScreen),
								A3(
								$author$project$Main$viewConditionOption,
								'Aurora Veil',
								$author$project$Main$SetDefenderSideAuroraVeil(true),
								model.field.defenderSide.isAuroraVeil),
								A3(
								$author$project$Main$viewConditionOption,
								'Tailwind',
								$author$project$Main$SetDefenderSideTailwind(true),
								model.field.defenderSide.isTailwind),
								A3(
								$author$project$Main$viewConditionOption,
								'Helping Hand',
								$author$project$Main$SetDefenderSideHelpingHand(true),
								model.field.defenderSide.isHelpingHand),
								A3(
								$author$project$Main$viewConditionOption,
								'Stealth Rock',
								$author$project$Main$SetDefenderSideStealthRock(true),
								model.field.defenderSide.isSteathRock),
								A3(
								$author$project$Main$viewConditionOption,
								'Spikes (1 layer)',
								$author$project$Main$SetDefenderSideSpikes(1),
								model.field.defenderSide.spikes === 1),
								A3(
								$author$project$Main$viewConditionOption,
								'Spikes (2 layers)',
								$author$project$Main$SetDefenderSideSpikes(2),
								model.field.defenderSide.spikes === 2),
								A3(
								$author$project$Main$viewConditionOption,
								'Spikes (3 layers)',
								$author$project$Main$SetDefenderSideSpikes(3),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex flex-wrap gap-2 min-h-[2rem]')
							]),
						$author$project$Main$viewActiveConditionPills(model))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$ToggleFieldConditionsDropdown),
								$elm$html$Html$Attributes$class('btn btn-xs btn-outline btn-primary w-full')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('+ Add Field Condition')
							])),
						model.fieldConditionsDropdownOpen ? A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('absolute top-full left-0 right-0 mt-1 bg-base-100 border border-base-300 rounded shadow-lg z-20 max-h-96 overflow-y-auto')
							]),
						_List_fromArray(
							[
								$author$project$Main$viewFieldConditionsDropdownMenu(model)
							])) : $elm$html$Html$text('')
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				model.showResetConfirmDialog ? A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50'),
						$elm$html$Html$Events$onClick($author$project$Main$CancelResetGameData)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('bg-base-200 p-6 rounded-lg shadow-xl max-w-md'),
								A2(
								$elm$html$Html$Events$stopPropagationOn,
								'click',
								$elm$json$Json$Decode$succeed(
									_Utils_Tuple2($author$project$Main$CancelResetGameData, true)))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('text-lg font-bold mb-4')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('⚠️ Reset Game Data?')
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('mb-4 text-sm')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('This will permanently delete all data for '),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(model.selectedGame)
											])),
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('list-disc list-inside mb-4 text-sm space-y-1')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text('All Pokemon in your team')
											])),
										A2(
										$elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('All Pokemon in your box')
											])),
										A2(
										$elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('Current trainer progress')
											])),
										A2(
										$elm$html$Html$li,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('Current attacker and defender')
											]))
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('mb-4 text-sm font-semibold text-error')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('flex gap-2 justify-end')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$ConfirmResetGameData),
												$elm$html$Html$Attributes$class('btn btn-sm btn-error')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Yes, Reset Game Data')
											]))
									]))
							]))
					])) : $elm$html$Html$text(''),
